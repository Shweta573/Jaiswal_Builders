<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bricks-details.aspx.cs" Inherits="bricks_details" %>
     ...
     <script>
         ...
         function showDetail() {
            ...
            /* detail.querySelector('.price').innerText = 'Rs.' + thisProduct.price + '/-';*/
             ...
             const similarProducts = products.filter(value => value.id != productId && value.id >= 6 && value.id <= 9);
