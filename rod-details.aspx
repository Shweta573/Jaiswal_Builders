<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rod-details.aspx.cs" Inherits="rod_details" %>
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/style.css?ref=9">
...
<script src="assets/js/image-reveal-hover.js"></script>
     ...
     <script>
         ...
         function showDetail() {
             ...
             const similarProducts = products.filter(value => value.id != productId && value.id >= 14 && value.id <= 20);
