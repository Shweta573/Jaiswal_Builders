<%@ Page Language="C#" AutoEventWireup="true" CodeFile="concrete-details.aspx.cs" Inherits="concrete_details" %>
     ...
     <script>
         ...
         function showDetail() {
            ...
            /* detail.querySelector('.price').innerText = 'Rs.' + thisProduct.price + '/-'*/;
             ...
             const similarProducts = products.filter(value => value.id != productId && value.id >= 10 && value.id <= 13);
