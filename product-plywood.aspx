<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product-plywood.aspx.cs" Inherits="product_plywood" %>
...
<!-- Header area end -->
    ...
    <div class="contact-bg">
        ...
        <p class="text">Plywood can naturally withstand a lot of stress and full weather exposure
        </p>
    </div>
    </section>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            fetch('products.json')
                ...
                .then(data => {
                    ...
                    products = data.filter(product => product.id >= 28 && product.id <= 31);
                    addDataToHTML();
                })
            ...
            function addDataToHTML() {
                ...
                if (products) { // If filtered data is available
                    products.forEach(product => {
                        ...
                        newProduct.href = 'plywood-details.aspx?id=' + product.id;
