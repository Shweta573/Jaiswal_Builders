<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Waterproofing-compounds.aspx.cs" Inherits="Waterproofing_compounds" %>
...
<!-- Header area end -->
    ...
    <div class="contact-bg">
        <h3>Our Products</h3>
        <h2>Waterproofing Compounds</h2>
        <div class="line">
            <div></div>
            <div></div>
            <div></div>
        </div>
        <p class="text">Waterproofing compounds are to be used with cement while making a waterproof structure
        </p>
    </div>
    </section>
  ...
  <%--  <div class="c">
        <div class="right-box">
            <div class="main-image-box">
                <img src="assets\imgs\products\Bricks\01.jpg" id="mainImage" class="main-image" />
            </div>
            <div class="small-images">
                <div class="image-box"><img src="assets\imgs\products\Bricks\02.jpg" class="image"  /></div>
                <div class="image-box"><img src="assets\imgs\products\Bricks\03.jpg" class="image" /></div>
                <div class="image-box"><img src="assets\imgs\products\Bricks\01.jpg" class="image" /></div>
                
            </div>
            
        </div>
        <div class="details-box">
            <h1>Common Burnt Clay Bricks</h1>
           ...
           <h6 class="l" style="font-weight:400">A brick is a type of construction material used to build walls, pavements and other elements in masonry construction.</h6>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            fetch('products.json')
                ...
                .then(data => {
                    ...
                    products = data.filter(product => product.id >= 32 && product.id <= 35);
                    addDataToHTML();
                })
            ...
            function addDataToHTML() {
                ...
                if (products) { // If filtered data is available
                    products.forEach(product => {
                        ...
                        newProduct.href = 'waterproofingdetails.aspx?id=' + product.id;
