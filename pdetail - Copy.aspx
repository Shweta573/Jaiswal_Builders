<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pdetail - Copy.aspx.cs" Inherits="pdetail" %>
...
<script src="assets/js/image-reveal-hover.js"></script>
     ...
     <script>
         ...
         function showDetail() {
             ...
             const similarProducts = products.filter(value => value.id != productId && value.id >= 1 && value.id <= 5);
             listProduct.innerHTML = ''; // Clear any existing items

             similarProducts.forEach(product => {
                 const newProduct = document.createElement('a');
                 newProduct.href = 'pdetail.aspx?id=' + product.id;
