<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product-aacblock.aspx.cs" Inherits="product_aacblock" %>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            fetch('products.json')
                ...
                .then(data => {
                    ...
                    products = data.filter(product => product.id >= 21 && product.id <= 24);
                    addDataToHTML();
                })
