<%@ Page Language="C#" AutoEventWireup="true" CodeFile="plywood-details.aspx.cs" Inherits="plywood_details" %>
     ...
     <script>
         ...
         function showDetail() {
            ...
            /* detail.querySelector('.price').innerText = 'Rs.' + thisProduct.price + '/-';*/
             ...
             const similarProducts = products.filter(value => value.id != productId && value.id >= 28 && value.id <= 31);
