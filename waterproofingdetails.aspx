<%@ Page Language="C#" AutoEventWireup="true" CodeFile="waterproofingdetails.aspx.cs" Inherits="waterproofingdetails" %>
     ...
     <script>
         ...
         function showDetail() {
            ...
            /* detail.querySelector('.price').innerText = 'Rs.' + thisProduct.price + '/-';*/
             ...
             const similarProducts = products.filter(value => value.id != productId && value.id >= 32 && value.id <= 35 );
