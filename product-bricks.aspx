<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product-bricks.aspx.cs" Inherits="product_bricks" %>
...
<!-- Header area end -->
    ...
    <div class="contact-bg">
        ...
        <p class="text">Ideal, well-crafted bricks for building enduring, timeless structures.
        </p>
    </div>
    </section>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            fetch('products.json')
                ...
                .then(data => {
                    ...
                    products = data.filter(product => product.id >= 6 && product.id <= 9);
                    addDataToHTML();
                })
